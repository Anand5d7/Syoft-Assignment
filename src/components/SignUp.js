...
const SignUp = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://syoft.dev/Api/user_registeration/api/user_registeration', payload)
      .then(response => {
        if (response.data.status === false && response.data.msg === 'Already Exists') {
  ...
  return (
    <div className='signup'>
      ...
      <div className="signup-left">
        <h1 className='title'>Welcome to <br /> our community</h1>
      ...
      <div className="signup-right">
        <img src='logoImage.png' alt='' className='logo-image' />
        <h2 className='side-head'>Sign Up</h2>
        <p className='line'>Already have an account? <a className='underline' href='/login'>Sign In</a></p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <label>I agree to the <a className='underline' href="#">Terms of Service</a> and <a className='underline' href="#">Privacy Policy</a></label>
          </div>
